...
package sfty_test.postgres_test_job_0_1;
...
/**
 * Job: Postgres_test_job Purpose: test_job for talend cicd<br>
 * Description: talend cicd <br>
 * 
 * @author Edala, Surendra
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Postgres_test_job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Postgres_test_job.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Postgres_test_job.class);
	...
	private final String jobName = "Postgres_test_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Postgres_test_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Postgres_test_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_SFTY_TEST_Postgres_test_job = new byte[0];
		static byte[] commonByteArray_SFTY_TEST_Postgres_test_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SFTY_TEST_Postgres_test_job.length) {
					if (length < 1024 && commonByteArray_SFTY_TEST_Postgres_test_job.length == 0) {
						commonByteArray_SFTY_TEST_Postgres_test_job = new byte[1024];
					} else {
						commonByteArray_SFTY_TEST_Postgres_test_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SFTY_TEST_Postgres_test_job, 0, length);
				strReturn = new String(commonByteArray_SFTY_TEST_Postgres_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SFTY_TEST_Postgres_test_job, 0, length);
				strReturn = new String(commonByteArray_SFTY_TEST_Postgres_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SFTY_TEST_Postgres_test_job) {
				...
				try {
					...
					this.SLOT = readString(dis);

					this.GATE = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.SLOT, dos);

				// String

				writeString(this.GATE, dos);
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:Kp5ufM/MmYLXvUfDjhjpLJbYLWVYsi8BS7NNLwn2dYD+ubrN")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"airfares_1\\\".\\\"serial_id\\\",    \\\"airfares_1\\\".\\\"S_CITY\\\",    \\\"airfares_1\\\".\\\"E_CITY\\\",    \\\"airfares_1\\\".\\\"VACATION\\\",    \\\"airfares_1\\\".\\\"DISTANCE\\\",    \\\"airfares_1\\\".\\\"FARE\\\" FROM \\\"airfares_1\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("serial_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("S_CITY") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("E_CITY")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("VACATION") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("DISTANCE") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("FARE") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XlImE2q+XfluCMe2/Z0nRidKKmq/P6S+oOIGTO9wUzcWv9YQ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.serial_id = '" +
							// row2HashKey.serial_id + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.serial_id = row1.serial_id;
						...
						if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row3.serial_id = '" +
							// row3HashKey.serial_id + "'");
						} // G 071
...
// # Output table : 'out1'
							...
							out1_tmp.SLOT = row3.SLOT;
							out1_tmp.GATE = row3.GATE;
							out1 = out1_tmp;
...
///////////////////////		
							...
							if (out1.serial_id != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.serial_id));
							...
							if (out1.S_CITY != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.S_CITY));
							...
							if (out1.E_CITY != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.E_CITY));
							...
							if (out1.VACATION != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.VACATION));
							...
							if (out1.DISTANCE != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.DISTANCE));
							...
							if (out1.FARE != null) { //
								...
								strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(out1.FARE));
							...
							if (out1.S_INCOME != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.S_INCOME));
							...
							if (out1.E_INCOME != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.E_INCOME));
							...
							if (out1.S_POP != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.S_POP));
							...
							if (out1.E_POP != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.E_POP));
							...
							if (out1.SLOT != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.SLOT));
							...
							if (out1.GATE != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.GATE));
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:RBtTFKOE+Y2FKdiYkrB1T6RuV5o10Nm3Zr7nEQDTcnNXMWbG")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERY" + " = "
									+ "\"SELECT    \\\"airfares_2\\\".\\\"serial_id\\\",    \\\"airfares_2\\\".\\\"S_INCOME\\\",    \\\"airfares_2\\\".\\\"E_INCOME\\\",    \\\"airfares_2\\\".\\\"S_POP\\\",    \\\"airfares_2\\\".\\\"E_POP\\\" FROM \\\"airfares_2\\\"\"");
							log4jParamters_tDBInput_2.append(" | ");
							...
							log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("serial_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("S_INCOME") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("E_INCOME")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("S_POP") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("E_POP") + "}]");
							log4jParamters_tDBInput_2.append(" | ");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:aeIHGxDW+AR8ztxZTagVOYjF5Cb9chUUkDlHnmst3hBPSy1q");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.SLOT = readString(dis, ois);

				this.GATE = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.SLOT = readString(dis, objectIn);

				this.GATE = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.SLOT, dos, oos);

				writeString(this.GATE, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.SLOT, dos, objectOut);

				writeString(this.GATE, dos, objectOut);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("HOST" + " = " + "\"192.168.1.95\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("PORT" + " = " + "\"5432\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("DBNAME" + " = " + "\"postgres\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("SCHEMA_DB" + " = " + "\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("USER" + " = " + "\"postgres\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:rUtrJA8ymwoKEQLSntdr8PqWeT21tBSnAu8zkboq/O2VR8zR")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERY" + " = "
									+ "\"SELECT    \\\"airfares_3\\\".\\\"serial_id\\\",    \\\"airfares_3\\\".\\\"SLOT\\\",    \\\"airfares_3\\\".\\\"GATE\\\" FROM \\\"airfares_3\\\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							...
							log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("serial_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("SLOT") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("GATE") + "}]");
							log4jParamters_tDBInput_3.append(" | ");
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:BXO7WbIAxuIRfebQIfUGgYwsYA1j+Sl5Ri71ukF6AQlnSmUT");

				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;

				String url_tDBInput_3 = "jdbc:postgresql://" + "192.168.1.95" + ":" + "5432" + "/" + "postgres";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row3.serial_id = rs_tDBInput_3.getLong(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row3.SLOT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							row3.GATE = null;
						} else {

							row3.GATE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_3", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row3",
						...
						row3_HashRow.serial_id = row3.serial_id;

						row3_HashRow.SLOT = row3.SLOT;

						row3_HashRow.GATE = row3.GATE;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_3", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row3", "tAdvancedHash_row3",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final Postgres_test_job Postgres_test_jobClass = new Postgres_test_job();

		int exitCode = Postgres_test_jobClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Postgres_test_job' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Postgres_test_job' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Postgres_test_job.class.getClassLoader()
					.getResourceAsStream("sfty_test/postgres_test_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Postgres_test_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Postgres_test_job");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 153492 characters generated by Talend Cloud Data Management Platform on the
 * August 19, 2022 at 3:31:36 PM IST
 ************************************************************************************************/